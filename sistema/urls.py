...
from sistema.views import  create_systems, horarios_view, sistema_view, create_varios_sistemas, login_view, cadastro_view, listar_alunos_view, listar_professores_view, listar_turmas_view, ultimas_aulas_view, create_systems_completo, confirmacao_conflito
